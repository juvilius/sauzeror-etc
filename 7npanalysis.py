...
for pdb in random.sample(list(truth), 400):
    ...
    if len(tr) > 0:
        print(qid[tr[0]], pdb)
        os.system('python 4new_params_sauzeror.py -mp align /home/julius/databases/dalilite_benchmark/structure_data/scope140_pdb/{0}.ent /home/julius/databases/dalilite_benchmark/structure_data/pdb_and_scope/{1}.pdb.gz -o ./table_clutter/{0}{1}.4np3table'.format(qid[tr[0]], pdb))
